// Exercise 7.15
//
// Modify Program 7.15 so that the user can convert any number of integers. Make
// provision for the program to terminate when a zero is typed in as the value of
